...
namespace IRT
{
    public class Container<T> : IEnumerable<T> where T : class, IName, IName<T>, IPrice, ICustomSerializable, new()
    {
        private T[] items;
        ...
        public static Container<T> Deserialize(BinaryReader reader)
        {
            ...
            {
                //T obj = new T();
                //obj = (T)obj.Deserialize(reader);
                T obj = (T)typeof(T).GetMethod("Deserialize").Invoke(null, new object[] { reader });
                container.Add(obj);
            }
            return container;
        }
    ...
    public class ContainerLinkedList<T> : IEnumerable<T> where T : class, IName, IName<T>, IPrice, ICustomSerializable, new()
    {
        public class Node
        {
